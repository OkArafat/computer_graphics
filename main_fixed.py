...
def draw_stars():
	...
	for s in stars:
		...
		glColor3f(celestial_palette["stars"][0], celestial_palette["stars"][1], celestial_palette["stars"][2])
		glPushMatrix()
		glTranslatef(x, y, z)
		s = sz
		glBegin(GL_QUADS)
...
def draw_sun():
	...
	glTranslatef(x, y, z)
	glColor3f(celestial_palette["sun"][0], celestial_palette["sun"][1], celestial_palette["sun"][2])
...
def draw_moon():
	...
	glTranslatef(x, y, z)
	glColor3f(celestial_palette["moon"][0], celestial_palette["moon"][1], celestial_palette["moon"][2])
...
def draw_car():
	...
	if cheat_active:
		...
		color_cabin = (0.0, 0.0, 1.0)
		color_hood = (0.0, 0.0, 1.0)
